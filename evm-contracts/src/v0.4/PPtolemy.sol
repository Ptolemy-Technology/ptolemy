...
// File: contracts/vendor/PSafeMath.sol
...
// File: contracts/interfaces/PtolemyInterface.sol
...
/**
 * @title The Chainlink Ptolemy contract
 * @notice Node operators can deploy this contract to fulfill requests sent to them
 */
contract Ptolemy is ChainlinkRequestInterface, PtolemyInterface, Ownable {
   ...
   * Emits PtolemyRequest event for the Chainlink node to detect.
  ...
  function cancelPtolemyRequest(
    ...
    delete commitments[_requestId];
    emit CancelPtolemyRequest(_requestId);
